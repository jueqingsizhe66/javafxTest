...
public class VTableTest extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        var table2 = new VTableView<DataVFX129>();
        var aCol = new VTableColumn<DataVFX129, Integer>("a", d -> d.a);
        var bCol = new VTableColumn<DataVFX129, String>("b", d -> d.b);
